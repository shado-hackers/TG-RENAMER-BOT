    ...
    if Config.FORCE_SUB:
        try:
            ...
            if chat.status=='kicked':
                return await m.reply_text('Hai you are kicked from my updates channel. So, you are not able to use me'⚠️,  quote=True)
            ...
            logger.error(e)
            return await m.reply_text("Some thing went wrong. Try again and if same issue occur contact [our group](https://t.me/nexleech)", disable_web_page_preview=True, quote=True)
